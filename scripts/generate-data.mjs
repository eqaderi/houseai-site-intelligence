...
const translationsFa = {
  ...
  windLead: "گل‌بادها از ۸۷٬۶۷۲ رکورد ساعتی ERA5-Land در سال‌های ۲۰۱۱ تا ۲۰۲۰ ساخته شده‌اند. باد داخل ملک ممکن است به‌دلیل پستی‌وبلندی فرق کند؛ جهت و سرعت نهایی باید در محل اندازه‌گیری شود.",
  ...
  investigationsTitle: "نوزده موضوع که به فرد متخصص، ابزار یا مجوز نیاز دارند",
  gate: "مرحله",

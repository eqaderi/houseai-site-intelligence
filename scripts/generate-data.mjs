...
const architecturalReadiness = {
  ...
  summary: bi(
    "Site strategy and consultant briefing may begin. Concept design must wait for the client brief, certified legal/survey evidence, planning controls, road geometry and preliminary ground assessment.",
    "بررسی راهبرد سایت و هماهنگی مشاوران می‌تواند شروع شود. برای شروع طراحی مفهومی هنوز باید خواسته‌های خانواده، مدارک قانونی و نقشه‌برداری، ضوابط، وضعیت راه و شرایط اولیه زمین مشخص شود.",
  ),
  states: [
    {
      id: "usable-now",
    ...
    },
    {
      ...
      evidence: [
        ...
        bi("Envelope, orientation, drainage and access hypotheses that still require local testing", "فرضیه‌های پوسته، جهت‌گیری، زهکشی و دسترسی که هنوز به آزمون محلی نیاز دارند"),
      ],
    },
    {
      id: "blocks-concept",
      ...
      evidence: [
        bi("Client brief: household, program, target area, privacy, budget, phasing and future needs", "شرح پروژه: خانوار، برنامه فیزیکی، مساحت هدف، حریم، بودجه، فازبندی و نیازهای آینده"),
        bi("Certified cadastral/legal boundary, title, easements, rights-of-way and surveyor-certified CRS", "مرز ثبتی/قانونی معتبر، سند، حقوق ارتفاقی و عبور و CRS تأییدشده توسط نقشه‌بردار"),
        bi("Planning controls, setbacks, height, parking, fire access and permit route", "ضوابط، عقب‌نشینی، ارتفاع، پارکینگ، دسترسی آتش‌نشانی و مسیر مجوز"),
        bi("Detailed topography with breaklines plus road grade, gate and turning geometry", "توپوگرافی دقیق با شکست‌خط‌ها و شیب راه، دروازه و هندسه گردش"),
        bi("Preliminary geotechnical and slope-stability assessment", "ارزیابی اولیه ژئوتکنیک و پایداری شیب"),
      ],
    },
  ],
};
...
const clientBrief = {
  status: "unresolved",
  note: bi(
    "No client-program answers are present in the verified project sources. Every field below is intentionally unresolved and must be completed with the household before concept design.",
    "هیچ پاسخ برنامه‌ریزی کارفرما در منابع تأییدشده پروژه وجود ندارد. همه موارد زیر عمداً حل‌نشده‌اند و باید پیش از طراحی مفهومی با خانوار تکمیل شوند.",
  ),
  fields: [
    ["household", "Household composition", "ترکیب خانوار"],
    ["room-program", "Room and space program", "برنامه فضاها و اتاق‌ها"],
    ["target-area", "Target internal and external areas", "مساحت هدف داخلی و بیرونی"],
    ["accessibility", "Accessibility and ageing-in-place needs", "دسترس‌پذیری و نیازهای سالمندی در محل"],
    ["privacy-culture", "Privacy, hosting and cultural needs", "نیازهای حریم، پذیرایی و فرهنگی"],
    ["budget", "Budget range and cost priorities", "بازه بودجه و اولویت‌های هزینه"],
    ["phasing", "Phasing and occupied-construction needs", "فازبندی و نیازهای ساخت در زمان سکونت"],
    ["timeline", "Decision and construction timeline", "زمان‌بندی تصمیم‌گیری و ساخت"],
    ["construction", "Construction system and material preferences", "ترجیحات سیستم ساخت و مصالح"],
    ["garage-workshop", "Garage, workshop and vehicle requirements", "نیازهای گاراژ، کارگاه و خودرو"],
    ["energy-carbon", "Energy, comfort and carbon goals", "اهداف انرژی، آسایش و کربن"],
    ["future-expansion", "Future expansion and adaptability", "توسعه آینده و انعطاف‌پذیری"],
  ].map(([id, en, fa]) => ({
    id,
    label: bi(en, fa),
    status: "unresolved",
...
const recommendations = {
  ...
  items: [
    ...
    ["courtyard", "Courtyard question", "پرسش حیاط", "requires-investigation", "Test whether the household wants a courtyard and what privacy, use and maintenance it must support; only then test locations that can drain positively without relying on an unverified retaining scheme.", "ابتدا مشخص شود خانوار حیاط می‌خواهد یا نه و چه نیازهای حریم، استفاده و نگهداری دارد؛ سپس مکان‌هایی آزموده شود که بدون اتکا به طرح حائل تأییدنشده، زهکشی مثبت داشته باشند."],
    ["bedrooms", "Bedroom questions", "پرسش‌های اتاق‌خواب", "requires-investigation", "Confirm bedroom count, occupants, privacy, accessibility, views and noise tolerance before testing any orientation; no room side is selected.", "پیش از آزمودن هر جهت، تعداد اتاق‌خواب، کاربران، حریم، دسترس‌پذیری، دید و تحمل صدا مشخص شود؛ هیچ سمت اتاقی انتخاب نشده است."],
    ["living", "Living-area questions", "پرسش‌های فضای نشیمن", "requires-investigation", "Confirm household patterns, hosting, privacy and desired outdoor relationship before testing where living spaces could sit; no terrace or level is promised.", "پیش از آزمودن محل فضاهای نشیمن، الگوی زندگی خانوار، پذیرایی، حریم و رابطه مطلوب با بیرون مشخص شود؛ هیچ تراس یا ترازی تضمین نشده است."],
    ["kitchen", "Kitchen questions", "پرسش‌های آشپزخانه", "requires-investigation", "Confirm cooking pattern, separation, service access, storage, fuel and extract requirements before testing daylight or adjacency options.", "پیش از آزمودن گزینه‌های نور یا مجاورت، الگوی آشپزی، میزان جداسازی، دسترسی خدماتی، انبارش، سوخت و نیازهای هواکش مشخص شود."],
    ["office", "Office questions", "پرسش‌های دفتر کار", "requires-investigation", "Confirm users, working hours, acoustic privacy, glare tolerance and visitor access before testing orientation; road noise has not been measured.", "پیش از آزمودن جهت، کاربران، ساعات کار، حریم صوتی، تحمل خیرگی و دسترسی مراجعان مشخص شود؛ صدای راه اندازه‌گیری نشده است."],
    ["garage", "Garage / workshop gate", "شرط گاراژ / کارگاه", "requires-investigation", "Do not place a garage, workshop or gate yet. First measure road longitudinal and crossfall grade, gate geometry, vehicle swept paths, emergency access and construction access; the Pt2–Pt1 edge proves frontage only.", "هنوز گاراژ، کارگاه یا دروازه جانمایی نشود. ابتدا شیب طولی و عرضی راه، هندسه دروازه، مسیر گردش خودرو، دسترسی اضطراری و دسترسی ساخت اندازه‌گیری شود؛ لبه Pt2–Pt1 فقط وجود برِ راه را نشان می‌دهد."],
...
const documents = {
  ...
  rejected_concepts: {
    ...
    note: bi(
      "Early house-plan experiments are retained only in a closed archive. They were rejected, are unvalidated, and are excluded from recommendations and the active document library.",
      "آزمایش‌های اولیه پلان خانه فقط در بایگانی بسته نگهداری می‌شوند. آن‌ها ردشده و اعتبارسنجی‌نشده‌اند و از توصیه‌ها و کتابخانه فعال اسناد کنار گذاشته شده‌اند.",
    ),
  },
};
...
const translationsEn = {
  ...
  clientBriefTitle: "Twelve decisions the household still needs to make",
  clientBriefLead: "Unanswered items stay unresolved; no program, budget or lifestyle requirement is inferred.",
  ...
  rejectedArchive: "Rejected and unvalidated concept experiments — not for selection",
  rejectedNote: "Closed by default. These experiments were rejected, are not ranked, and are not design recommendations or feasibility evidence.",
  ...
  // Rejected concept archive. It is closed, unranked, and never part of the
  // primary design story.
  concepts: "Rejected concept archive",
  conceptsKicker: "Archive only · rejected · unvalidated",
  conceptsTitle: "Three early experiments retained for audit only",
  conceptsLead: "These room-and-massing experiments predate the required client, planning, road and ground evidence. They are shown only to preserve project history and must not be selected or treated as feasible.",
  showConcepts: "Rejected concepts",
  ariaConceptOption: "Archived experiment",
  colMetric: "Metric",
...
const translationsFa = {
  ...
  clientBriefTitle: "دوازده تصمیمی که خانوار هنوز باید بگیرد",
  clientBriefLead: "تا وقتی خانواده پاسخ ندهد، هر مورد حل‌نشده می‌ماند. این داشبورد درباره فضاها، بودجه یا شیوه زندگی حدس نمی‌زند.",
  ...
  climateLead: "دما، بارش، برف و یخبندان از داده ERA5-Land در سال‌های ۱۹۹۱ تا ۲۰۲۰ آمده است. رطوبت، ابر و تابش از NASA POWER است. این داده‌ها منطقه‌ای‌اند، نه اندازه‌گیری داخل سایت.",
  ...
  solarLead: "مسیر خورشید برای مختصات محتمل سایت از قبل محاسبه شده است. خط افق از مدل ارتفاعی ۹۰ متری می‌آید. ساختمان‌های اطراف و درختان در این محاسبه نیستند.",
  season: "فصل",
  timeOfDay: "زمان روز",
  play: "پخش",
  pause: "توقف",
  ...
  windLead: "گل‌بادها از ۸۷٬۶۷۲ رکورد ساعتی ERA5-Land در سال‌های ۲۰۱۱ تا ۲۰۲۰ ساخته شده‌اند. جهت و سرعت باد داخل سایت ممکن است متفاوت باشد و باید در محل اندازه‌گیری شود.",
  ...
  hazardsLead: "اطلاعات لازم برای طراحی لرزه‌ای هنوز موجود نیست. در ادامه، هر خطر با برچسب روشن نشان می‌دهد که داده آن از نقشه، منبع منطقه‌ای، استنباط اولیه یا بررسی میدانی می‌آید.",
  ...
  architectureLead: "این بخش می‌گوید معمار چه موضوعی را می‌تواند بررسی کند و کدام تصمیم هنوز زود است. جای اتاق‌ها، ورودی خودرو و پلان خانه هنوز تعیین نشده است.",
  confidence: "اطمینان",
  documentsKicker: "کتابخانه پروژه",
  documentsTitle: "شواهد مفید، منظم و محلی",
  documentsLead: "همه فایل‌های این بخش داخل همین بسته قرار دارند و بدون اینترنت باز می‌شوند. تصویرهای اصلی و داده‌های قابل پردازش نیز در دسترس‌اند.",
  ...
  rejectedArchive: "آزمایش‌های مفهومی ردشده و اعتبارسنجی‌نشده — نامناسب برای انتخاب",
  rejectedNote: "این بخش بسته است چون طرح‌های داخل آن رد شده‌اند. هیچ گزینه‌ای برتر یا قابل انتخاب نیست. این طرح‌ها فقط سابقه کار را نشان می‌دهند.",
  methodsKicker: "رد ممیزی",
  methodsTitle: "منابع، محدودیت‌ها و بازتولیدپذیری",
  methodsLead: "در این بخش می‌توانید ببینید هر عدد از کجا آمده، چگونه محاسبه شده و چه محدودیتی دارد. برای دیدن این اطلاعات به اینترنت نیاز نیست.",
  ...
  concepts: "بایگانی مفاهیم ردشده",
  conceptsKicker: "فقط بایگانی · ردشده · اعتبارسنجی‌نشده",
  conceptsTitle: "سه آزمایش اولیه که فقط برای ممیزی نگهداری شده‌اند",
  conceptsLead: "این طرح‌های آزمایشی قبل از مشخص شدن خواسته‌های خانواده، ضوابط، وضعیت راه و شرایط زمین ساخته شده‌اند. فقط برای ثبت سابقه نگهداری می‌شوند و نباید یکی از آن‌ها را انتخاب کرد.",
  showConcepts: "مفاهیم ردشده",
  ariaConceptOption: "آزمایش بایگانی‌شده",
  colMetric: "شاخص",
  ...
  speciesTitle: `بررسی ${faDigits(species.species.length)} گونه درخت برای شرایط این سایت`,
  ...
  speciesAvoidLead: "این درختان سریع رشد می‌کنند، اما برای این سایت انتخاب مطمئنی نیستند. دلیل رد هر کدام در کارت آن نوشته شده است.",
